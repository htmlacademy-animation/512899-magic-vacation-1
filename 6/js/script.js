...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LetterAnimation; });
class LetterAnimation {
  constructor({element, duration, wordClass, letterClass, transitionProperty}) {
  ...
  createLetter(letter) {
    ...
    const timeOffset = Math.random() * this._TIME_SPACE;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LetterAnimation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LetterAnimation */ "./source/js/modules/LetterAnimation.js");


const addIntroTitleAnimation = () => {
  const elements = document.querySelectorAll(`.js-text-show`);
  elements.forEach((element) => {
    const animation = new _LetterAnimation__WEBPACK_IMPORTED_MODULE_0__["default"]({
      element,
      duration: 400,
...
/* harmony import */ var _modules_load__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/load */ "./source/js/modules/load.js");
...
Object(_modules_load__WEBPACK_IMPORTED_MODULE_8__["default"])();
